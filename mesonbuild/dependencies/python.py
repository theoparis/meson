    ...
    def get_windows_python_arch(self) -> T.Optional[str]:
        if self.platform == "mingw":
            ...
            if pycc.startswith("x86_64"):
                ...
                mlog.log(
                    f"MinGW Python built with unknown CC {pycc!r}, please file a bug"
                )
                return None
        ...
        if self.platform.startswith("win"):
            ...
            if self.static:
                ...
                if comp.id == "gcc":
                    ...
                    buildtype = self.env.coredata.get_option(
                        mesonlib.OptionKey("buildtype")
                    )
                    ...
                    if mesonlib.OptionKey("b_vscrt") in self.env.coredata.options:
                        vscrt = self.env.coredata.options[
                            mesonlib.OptionKey("b_vscrt")
                        ].value
                        if vscrt in {
                            "mdd",
                            "mtd",
